...
sealed class Screen(val route: String, val icon: ImageVector?, val resource: Int = 0) {
   ...
   data object HistoricoScreen : Screen("historico_screen", Icons.AutoMirrored.Filled.List)
   data object AdicionarScreen : Screen("adicionar_screen", Icons.Filled.Add)
